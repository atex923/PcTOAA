...
# - V4.3.x：整合右上原始/重新計算欄、0A 動態列、總經費公式、
#            可縮放版面、0A 項下單價讀取第二分頁，以及重新計算順序調整。
# - V4.4.0：0A1 到 0AA 的數量/單價讀取第二分頁，移除鎖定回填功能與相關邏輯。
...
DEFAULT_LOG_FILENAME = "BudgetAnalyzer_V4_4_0.budget_log.json"
...
class BudgetAnalyzerQT(QMainWindow):
    ...
    def sync_dynamic_calculations_to_combined(self, item_to_row):
        ...
        for item_code in target_codes:
            ...
            unit_price = values["calculated"].get(item_code)
