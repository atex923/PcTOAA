...
# - V4.2.j 右上金額區調整：
#   1. 0A3 公共藝術費最右欄改為組合總表項目 01 複價 × 1%。
...
DEFAULT_LOG_FILENAME = "BudgetAnalyzer_V4_2_j.budget_log.json"
...
class BudgetAnalyzerQT(QMainWindow):
    ...
    def update_dynamic_amount_labels(self):
        ...
        - 0A3 公共藝術費：左欄預算總表 0A3 複價，右欄組合總表項目 01 複價 × 1%
