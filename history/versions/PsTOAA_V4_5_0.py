...
DEFAULT_LOG_FILENAME = "BudgetAnalyzer_V4_5_0.budget_log.json"
...
class BudgetAnalyzerQT(QMainWindow):
    ...
    def delete_current_combined_row(self):
        ...
        self.msg_info("完成", f"已刪除組合總表第 {data_row + 1} 列\n項目：{item_code or '空白'}")
    ...
    def default_export_filename(self, extension):
        return str(Path.cwd() / f"PCCES轉換TRA_AA3118預算{APP_VERSION}TAISHOSANKE.{extension}")
