...
DEFAULT_LOG_FILENAME = "BudgetAnalyzer_V4_3_6.budget_log.json"
...
class BudgetAnalyzerQT(QMainWindow):
    ...
    def build_ui(self):
        ...
        self.amount_panel.setMinimumWidth(620)
        ...
        for row_no, code in enumerate(("0A1", "0A2", "0A3", "0A4", "0A5", "0A6"), start=5):
        ...
        amount_panel_layout.addWidget(self.amount_total_name_label, 11, 0)
        amount_panel_layout.addWidget(self.amount_total_value_label, 11, 1)
        amount_panel_layout.addWidget(self.amount_total_calc_name_label, 11, 2, 1, 2)
        amount_panel_layout.addWidget(self.amount_total_calc_value_label, 11, 4)
    ...
    def amount_0a_config(self, code):
        ...
        return source, 1.0 if ratio is None else ratio
    ...
    def dynamic_amount_values(self):
        amounts = {
            ...
            for code in (
                "0", "01", "011", "0B", "012", "0A1", "0A2", "0A3", "0A4", "0A5", "0A6",
                "02", "03", "04", "05", "06", "0A"
            )
        }
        ...
        for code in ("0A1", "0A2", "0A3", "0A4", "0A5", "0A6"):
            source, ratio = self.amount_0a_config(code)
    ...
    def sync_dynamic_calculations_to_combined(self, item_to_row):
        ...
        target_codes = ("012", "06", "0A1", "0A2", "0A3", "0A4", "0A5", "0A6")
        changed_cells = []
        changed = 0
