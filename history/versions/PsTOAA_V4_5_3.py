...
# - V4.5.2：視窗標題改為 PCCES 轉換 TRA_AA3118 預算命名，匯出預設檔名改為 AA3118 加年月日時分秒。
# - V4.5.3：匯出預設檔名改為 AA3118_工程編號_YYYYMMDDHHMMSS。
...
APP_VERSION = "V4.5.3"
APP_TITLE = f"PCCES轉換TRA_AA3118預算{APP_VERSION}TAISHOSANKE"
DEFAULT_LOG_FILENAME = "BudgetAnalyzer_V4_5_3.budget_log.json"
