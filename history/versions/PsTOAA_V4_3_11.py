...
# - V4.3.10：0A1 到 0AA 的數量/單價讀取第二分頁，移除鎖定回填功能；
#             重新計算時保留下半部手動單價，只用現有單價計算複價。
# - V4.3.11：0A1 到 0AA 重新計算時保留手動單價，左上欄框加黑框。
...
DEFAULT_LOG_FILENAME = "BudgetAnalyzer_V4_3_11.budget_log.json"
