...
DEFAULT_LOG_FILENAME = "BudgetAnalyzer_V4_3_4.budget_log.json"
...
class BudgetAnalyzerQT(QMainWindow):
    ...
    def display_amount_snapshot(self, calculated_side=False):
        ...
        current_total = amounts.get("0", 0.0) or sum(amounts[code] for code in ("01", "02", "03", "04", "05", "06", "0A"))
    ...
    def update_dynamic_amount_labels(self):
        ...
        for label, value in label_values:
            if label in integer_result_labels:
