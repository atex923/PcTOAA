...
# - V4.2.i 右上金額區調整：
#   1. 重新加入 06 工程管理費，左欄讀取項目 06 複價，右欄依級距公式取整數。
...
DEFAULT_LOG_FILENAME = "BudgetAnalyzer_V4_2_i.budget_log.json"
...
class BudgetAnalyzerQT(QMainWindow):
    ...
    def update_dynamic_amount_labels(self):
        ...
        - 06 工程管理費：左欄項目 06 複價，右欄依 (01 + 02) 級距試算
